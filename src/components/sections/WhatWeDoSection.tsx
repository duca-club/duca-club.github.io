...
export const WhatWeDoSection = () => {
  return (
    <section id="what-we-do" className="section-themed data-stream-bg relative overflow-hidden py-24">
            ...
            >
              <CometCard className="h-full">
                <a href={feature.href} className="group block h-full">
                  ...
                  <h3 className="mb-3 text-xl font-bold text-white transition-colors group-hover:text-purple-400">
                    {feature.title}
                  </h3>
