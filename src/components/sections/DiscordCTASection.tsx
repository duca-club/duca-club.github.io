            ...
            <div className="max-w-lg">
              ...
              <div className="mt-6">
                <Button
                  ...
                  variant="secondary"
                  className="landing-card-button-secondary bg-white text-purple-900 hover:bg-gray-100"
                >
          ...
          <WobbleCard containerClassName="col-span-1 bg-gradient-to-br from-cyan-600 via-teal-700 to-cyan-900 min-h-[300px] ring-1 ring-cyan-300/30">
            ...
            <div className="mt-6">
              <Button
                ...
                variant="secondary"
                className="landing-card-button-primary bg-white text-cyan-900 hover:bg-gray-100"
              >
                Register
              </Button>
            </div>
